  ...
  return (
    <div className=' mt-16 max-w-[1194px] w-full px-3 mx-auto'>
      ...
      <div className=' mt-[100px] grid grid-cols-3 max-xl:grid-cols-2 gap-[30px] max-sm:grid-cols-1 '>
        {
          exploreMore.map((item, index) => (<div key={index} className=' py-[38px_81px] pl-[30px] bg-no-repeat rounded-lg ' style={{
            backgroundColor: item.bg, backgroundImage: `url(${item.bgImg})`
          }} >
