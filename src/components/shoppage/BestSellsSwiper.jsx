  ...
  return (
    <div>
      ...
      <Swiper
          ...
          <SwiperSlide key={index}>
            <div className="border-[#939393] border-[0.7px] rounded-[12.65px] max-w-[265px] w-full relative overflow-hidden max-md:mx-auto">
              ...
              <div className="p-[14.06px] flex flex-col gap-2">
                ...
                <button className="w-[223px] h-[46px] cursor-pointer flex gap-[8] justify-center items-center rounded-[2.81px] bg-[#130017] text-white font-[Quicksand] font-bold mx-auto">
                  " {/* <Cart />" Add To Cart */}
                </button>
              </div>
              {/* product label */}
        ...
        {/* custom pagination */}
        {/* <div className="custom-pagination flex gap-2.5 justify-center mt-10.5 ">
...
// import Image from "next/image";
// // import { BestSellsData, ProductData } from "../common/Helper";
// // import { Cart, Nextbtn, Previbtn, Productl ike, ProductRatings, SoapSwiper } from "../common/icons";
// import { ProductData } from "../common/Helper";
// ;
// export default function BestSellsSwiper() {
//     const swiperRef = useRef(null);
